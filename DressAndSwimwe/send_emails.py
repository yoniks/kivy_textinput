...
def send_email_with_pdf(recive_email,id_order):
   ...
   try:
      with smtplib.SMTP_SSL("smtp.gmail.com", 465, context=context) as server:
          server.login("@gmail.com", os.environ.get('PASS_EMAIL'))
          #server.send_message(msg)
          server.sendmail("@gmail.com",recive_email, text)
          server.sendmail("@gmail.com","invoice.hani.design@gmail.com" , text)
          server.quit()
